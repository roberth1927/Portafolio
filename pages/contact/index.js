       ...
       <div className='container mx-auto py-32 text-center xl:text-left flex items-center justify-center h-full'>
          ...
          <div className='flex flex-col w-full max-w-[700px]'>
             ...
             <motion.h2 
               ...
               Vamos a <span className='text-naranja'>contactarnos</span>
             </motion.h2>
             ...
             <motion.form 
                    ...
                    animate='show'
                    exit='hidden'
                    className='flex-1 flex flex-col gap-6 w-full mx-auto border-naranja'>
               ...
               <div className='flex gap-x-6 w-full'>
                  ...
                  <input type='text' placeholder='asunto' className='input'></input>
